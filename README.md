...
| Domain | Expertise |
|--------|-----------|
| 🔍 Recon & Enumeration | Subdomain takeover, JS scraping, parameter mining, passive OSINT |
| 🧨 Exploitation | Advanced XSS (DOM, CSP bypass), SQLi to RCE, SSRF chaining, prototype pollution |
| 🔐 Authentication | JWT tampering, OAuth misconfig, SSO bypass, 2FA weaknesses |
...
| 📚 Methodologies | OWASP Top 10, Bug Bounty playbooks, PTES, MITRE ATT&CK (Web TTPs) |
...
- SSRF → cloud metadata exfiltration (AWS, GCP, Azure)  
...
- 🛠️ ReconCraft — Custom passive recon tool for JS scraping and endpoint extraction  
- 🧪 XSS Lab — Curated collection of real-world XSS vectors and CSP bypasses  
- 📖 BugWrite — Markdown-based reporting templates for clear, actionable vulnerability writeups  
- 🔍 AuthZ-Checklist — A practical checklist for testing authorization logic in modern web apps  

## 🧬 Philosophy

> “Security isn’t about paranoia — it’s about precision. I don’t just break things. I model how they fail.”
